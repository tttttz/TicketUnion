...
public class ScanQRCodeActivity extends FragmentActivity {
    ...
    public void handleDecode(Result result) {
        ...
        String targetUrl = result1.substring(5);
        LogUtil.d(this, "二维码/条形码 扫描结果" + targetUrl);

        if (targetUrl.contains("taobao.com")) {
            PresenterManager.getInstance().getTicketPresent().getTicket("", targetUrl, "");
            TickUtils.toTickPage(this, new IBaseInfo() {
                @Override
        ...
        //结果为：https:https://uland.taobao.com/coupon/edetail?e=XUDrRYzpoScNfLV8niU3R5TgU2jJNKOfNNtsjZw%2F%2FoLqFm8zb3eXppwuG8grMK9JqhkurpJU5rb48SdCVt1mCOmFKyIN1bVX65OH1WfUm95Uf2TiFOebey%2FP7NkoLxuAXfW7IvjNz3iOeUcSvy%2FHYmF5qFnaO9996DeX2ucVKhvHjZlrd41oqDjmjY2qbso6onv6QcvcARY%3D&&app_pvid=59590_11.15.96.76_55474_1591452554828&ptl=floorId:31539;app_pvid:59590_11.15.96.76_55474_1591452554828;tpp_pvid:&union_lens=lensId%3AOPT%401591452554%400b0f604c_0e8e_17289f6d6ef_afc7%4001
        //if (mScanerListener == null) {
